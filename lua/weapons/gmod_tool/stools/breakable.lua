...
function TOOL:LeftClick(trace)
    ...
    local gibs = {
        self:GetClientInfo("gib1"),
        self:GetClientInfo("gib2"),
        self:GetClientInfo("gib3"),
        self:GetClientInfo("gib4"),
		self:GetClientInfo("gib5"),
        self:GetClientInfo("gib6"),
        self:GetClientInfo("gib7"),
        self:GetClientInfo("gib8"),
		self:GetClientInfo("gib9"),
        self:GetClientInfo("gib10"),
        self:GetClientInfo("gib11"),
        self:GetClientInfo("gib12"),
		self:GetClientInfo("gib13"),
        self:GetClientInfo("gib14"),
        self:GetClientInfo("gib15"),
        self:GetClientInfo("gib16"),
		self:GetClientInfo("gib17"),
        self:GetClientInfo("gib18"),
        self:GetClientInfo("gib19"),
        self:GetClientInfo("gib20"),
		self:GetClientInfo("gib21"),
        self:GetClientInfo("gib22"),
        self:GetClientInfo("gib23"),
        self:GetClientInfo("gib24"),
        self:GetClientInfo("gib25")
    }
...
function TOOL.BuildCPanel(panel)
    panel:AddControl("Header", { Description = "Make props breakable with 25 gibs, custom health, and sound" })

    -- Preset system setup
    local preset_cvars = {
        "breakable_health",
        "breakable_sound",
        "breakable_nogibcollision"
    }
    for i = 1, 25 do
